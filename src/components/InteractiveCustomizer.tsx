...
const FURNITURE_TYPES = [
  { id: 'sofa', name: 'Royal Maharaja Sofa (3+2+1)', basePrice: 145000, img: '/maharaja_sofa.jpg' },
  { id: 'dining', name: 'Emperor Carved Dining Table (8-Seater)', basePrice: 88000, img: '/live_edge_dining.jpg' },
  { id: 'bed', name: 'Royal 4-Poster Master Bed', basePrice: 85000, img: '/canopy_poster_bed.jpg' },
  { id: 'desk', name: 'Executive Burma Teak Desk', basePrice: 64000, img: '/executive_desk.jpg' },
];
